...
export const SettingPage = () => {
  ...
  const [isFocused, setIsFocused] = React.useState(isFocusMode)
    ...
    const [isVideoRecommendations, setIsVideoRecommendations] = React.useState(isVideoRecommendationsDisabled)
    ...
    }, [isFocusMode, isShortsDisabled, isVideoRecommendationsDisabled, isCommentDisabled, notify])
    const handleSave = () => {
        ...
        <main className="rounded-xl shadow-lg backdrop-blur-md border border-[#27272a] dark:border-gray-700/50 overflow-hidden">
          ...
          <div className="divide-y divide-white/10 dark:divide-gray-700/30">
            ...
            <SettingItem
              ...
              onToggle={() => {setIsVideoRecommendations(!isVideoRecommendations);}}
            />
            <SettingItem
              ...
              checked={isComment}
              onToggle={() => {setIsComment(!isComment);}}
            />
            <SettingItem
          ...
          <div className="p-6 border-t border-[#27272a] backdrop-blur-sm flex justify-end">
            <Button onClick={() => {handleSave(); success()}} className="bg-white/90 backdrop-blur-md text-black border border-[#27272a] shadow-md hover:bg-white">
              Save Settings
            </Button>
          </div>
        </main>
...
function SettingItem({
  ...
  return (
    <div className="flex items-center justify-between p-6 transition-all duration-200 gap-2">
      ...
      <Switch className="border border-white shadow-sm ml-3" checked={checked} onChange={onToggle}/>
    </div>
  )
}
