    ...
    <div className="bg-zinc-900 rounded-2xl p-8 w-[95%] mx-auto shadow-2xl shadow-black/40">
      ...
      <div className="mb-8 space-y-2">
        <div className="flex items-center justify-between p-4 bg-zinc-800/50 rounded-xl">
          ...
          <span className="text-zinc-100 font-medium">Nikhil5289@gmail.com</span>
        </div>
        <div className="flex items-center justify-between p-4 bg-zinc-800/50 rounded-xl">
      ...
      <div className="flex gap-3 ">
        <button onClick={() => {window.location.href = "https://strater-app.vercel.app/signout_page"}} className="flex w-full gap-3 items-center justify-center flex-row bg-[#FF0042] hover:bg-[#FF0042]/90 text-white px-6 py-3 rounded-xl font-semibold transition-all">
         LogOut
